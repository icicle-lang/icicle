...
seaOfPrimBuiltinMath p = case p of
  ...
  M.PrimBuiltinAcos            -> idouble <> "acos"
  M.PrimBuiltinAsin            -> idouble <> "asin"
  M.PrimBuiltinAtan            -> idouble <> "atan"
  M.PrimBuiltinAtan2           -> idouble <> "atan2"
  M.PrimBuiltinCos             -> idouble <> "cos"
  M.PrimBuiltinCosh            -> idouble <> "cosh"
  M.PrimBuiltinSin             -> idouble <> "sin"
  M.PrimBuiltinSinh            -> idouble <> "sinh"
  M.PrimBuiltinTan             -> idouble <> "tan"
  M.PrimBuiltinTanh            -> idouble <> "tanh"
